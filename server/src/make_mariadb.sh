...
MARIADB_DEVEL_DOWNLOAD_PATH=http://yum.mariadb.org/10.0/centos7-amd64/rpms/$MARIADB_DEVEL.rpm
MARIADB_COMMON=MariaDB-10.0.37-centos73-x86_64-common
MARIADB_COMMON_DOWNLOAD_PATH=http://yum.mariadb.org/10.0/centos7-amd64/rpms/$MARIADB_COMMON.rpm
MARIADB_COMPAT=MariaDB-10.0.37-centos73-x86_64-compat
MARIADB_COMPAT_DOWNLOAD_PATH=http://yum.mariadb.org/10.0/centos7-amd64/rpms/$MARIADB_COMPAT.rpm
CUR_DIR=
